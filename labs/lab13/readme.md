...
Есть более изящный выход. Можно в качестве источников и назначения при настройке туннеля использовать уже настроенные интерфейсы 
...
При имитации повреждения на одном из соедениний с провайдером, соединение между сетями двух офисов прерывалась на время перестроения 
