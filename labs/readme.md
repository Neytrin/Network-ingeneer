...
![Shem_Project.png](TU_Project%2FStendLAB%2FShem_Project.png)
...
SW1#
````
Пример настройка SUB-интерфейсов на роутере R3. Здесь применим проприетарный протокол GLBP, который не настраивался в лабораторной работе.
...
Настроить на стыках с провайдерами EBGP.